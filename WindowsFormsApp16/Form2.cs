    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    info[0] = "Name: " + textBox1.Text;
                    info[1] = "Phone Number: " + textBox2.Text;
                    info[2] = "Email: " + textBox3.Text;
                    info[3] = "Age: " + comboBox1.SelectedItem;
                    info[4] = "Date : " + textBox4.Text;

                }
                Form4 f4 = new Form4();
                //foreach (Control c in f4.Controls)
                //{
                //    if (c.Name == "label3") c.Text = "name : " + textBox1.Text;
                //    if (c.Name == "label2") c.Text = "the time is : " + textBox4.Text;
                //}
                f4.fillingList(info);
                Form3 f3 = new Form3();
                f3.Show();
